...
public class VendorRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String query="insert into vendorregister(fname,lname,address,phone,email,password) values (?,?,?,?,?,?)";
...
if(i>0)
{
 out.println("<script type=\"text/javascript\">");
  out.println("alert('Vendor Register Sucessfully..');");
...
else
{
	 out.println("<script type=\"text/javascript\">");
	   ...
	   out.println("location='vendorRegister.jsp';");
	   out.println("</script>");
}
	} catch (Exception e) {
			e.printStackTrace();
