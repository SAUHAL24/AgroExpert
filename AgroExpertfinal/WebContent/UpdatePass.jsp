      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="password" method="post">
              <div class="form-label-group">
              <label for="inputEmail">Enter Password </label>
                <input type="text" id="inputEmail" name="password" class="form-control" placeholder="Password" required autofocus>
