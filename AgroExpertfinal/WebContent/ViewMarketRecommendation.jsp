    ...
    <div class="row">
      <div class="col-sm-10 col-md-3 col-lg-8 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">View Market recommendation</h5>
            <form class="form-signin" action="PredictionController" method="post" >
            
              <div class="form-label-group">
              <label for="inputEmail">Select Crop</label>
            
                <select  id="inputEmail" class="form-control" name="crop">
                  <%while(rs.next()){ %>
              ...
              <div class="form-label-group">
              <label for="inputPassword">Enter Date</label>
               <input type="date" name="date" class="form-control">
              </div>
               <div class="form-label-group">
               <label for="inputPassword">Season</label>
                <select type="text" id="inputPassword" class="form-control" name="season">
              ...
              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">View Market Recommendation</button>
              <hr class="my-4">
