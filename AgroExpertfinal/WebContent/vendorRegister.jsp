            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
                 ...
                 <li><a href="vendorlogin.jsp">Login</a></li>
                   <li><a href="vendorRegister.jsp">Register</a></li>
                </ul>
                <!-- Search Icon -->
    ...
    <div class="row">
      <div class="col-sm-6 col-md-9 col-lg-6 mx-auto">
        <div class="card card-signin my-7">
          <div class="card-body">
            <h5 class="card-title text-center">Vendor Register </h5>
            <form class="form-signin" action="VendorRegister" method="post">
             <div class="form-label-group">
             <label for="inputEmail">First Name</label>
                <input type="text" id="inputEmail" name="fname" pattern="^[A-Za-z]+$" class="form-control" placeholder="Enter First Name" required autofocus>
              </div>
               <div class="form-label-group">
               ...
               <label for="inputEmail">Phone No</label>
                <input type="number" id="inputEmail" name="phone"  class="form-control" pattern="[789][0-9]{9}" placeholder="Enter PhoneNo" pattern="[7-9]{1}[0-9]{9}" required >
              ...
              <label for="inputPassword">Password</label>
                <input type="password" id="inputPassword" name="password" class="form-control"  placeholder="Enter Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required>
