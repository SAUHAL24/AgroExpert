      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="OTP" method="post">
              <div class="form-label-group">
              <label for="inputEmail">Email OTP</label>
                <input type="text" id="inputEmail" name="OTP" class="form-control" placeholder="OTP" required autofocus>
