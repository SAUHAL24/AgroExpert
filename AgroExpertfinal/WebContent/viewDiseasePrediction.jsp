      ...
      <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/7.jpg);">
        <div class="container h-100">
          <div class="row h-90 align-items-center">
			...
			String query="select DISTINCT crop from cropinfo";
    ...
    <div class="row">
      <div class="col-sm-10 col-md-3 col-lg-8 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Enter Crop Name</h5>
            <form action="viewDiseasePrediction2.jsp" method="post" class="form-signin">
            ...
            </div> <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">View Disease Prediction</button>
              <hr class="my-4">
