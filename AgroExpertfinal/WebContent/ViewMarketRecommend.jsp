...
<%@page import="bean.resultComparator"%>
<%-- <%@page import="bean.resultComparator"%> --%>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="classy-menu">
              ...
              <div class="classynav">
                <ul>
                  ...
                  <li><a href="farmerhome.jsp">Farmer</a></li>
                   <li><a href="farmerhome.jsp">View Pesticide Recommendation</a></li>
                    <li><a href="farmerhome.jsp">View Market</a></li>
 ...
 <div class="single-welcome-slides bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/7.jpg);">
        <div class="container h-90">
          <div class="row h-90 align-items-center">
			...
			<%
								ArrayList<DataBean> result=(ArrayList)session.getAttribute("result");
								String mname=null;
								float rate=0;
								int c=1;
								Collections.sort(result,new resultComparator());  
								Iterator<DataBean> itr=result.iterator();
								while(itr.hasNext())
								{
			...
			String qery="select * from distance where city='"+mname+"'";
			PreparedStatement ps=con.prepareStatement(qery);
			ResultSet rs=ps.executeQuery();
			while(rs.next())
			{
				double lat2=Double.valueOf(rs.getString(3));
				double lon2=Double.valueOf(rs.getString(4));
    ...
    <th>Market Name</th>
     <th>Expected Market Price</th>
      <th>Distance</th>
	   ...
	   <tr>
  <td>Our System Recommend you <%=mname%> market for selling your product</td><br></br>
   <td>Expected rate is <%=rate%> per kg.</td>
    <td>Distance is<%=distance %></td>
  </tr>
<%
	String msg="System Recommend you "+mname+" market for selling your product and Expected rate is "+rate+" per kg.";
%>
</table>
<%} %>
